...
namespace GameAnalyticsSDK
{
    ...
    public partial class GameAnalytics : MonoBehaviour
    {
        ...
        private static Setup.Settings _settings;

        public static Setup.Settings SettingsGA
        {
            get
            {
                if(_settings == null)
        ...
        private static void InitAPI()
        {
            try
            {
                _settings = (Setup.Settings)Resources.Load("GameAnalytics/Settings", typeof(Setup.Settings));
                ...
                if(_settings == null)
                {
                    ...
                    var asset = ScriptableObject.CreateInstance<Setup.Settings>();
        ...
        private static void InternalInitialize()
        {
            ...
            GA_Wrapper.SetUnitySdkVersion("unity " + Setup.Settings.VERSION);
